...
namespace SAUEP.ApiServer.Controllers
{
    ...
    public class DeviceController : ControllerBase
    {
            ...
            double minElecticityConsumption)
        {
            ...
            _guardian.Secure(() => _deviceRepository.Set(new DeviceModel(deviceGroup, serial, title, ip, port, status, maxPower, minPower, maxElecticityConsumption, minElecticityConsumption)));
            return Ok();
        }
